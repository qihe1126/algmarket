...
import unittest
import Algmarket
from Algmarket.acl import AclType, Acl, ReadAcl
...
class AclTypeTest(unittest.TestCase):
    def test_types(self):
        ...
        self.assertEquals(AclType.my_algos.acl_string, 'algm://.my/*')
    ...
    def test_from_acl_response(self):
        ...
        self.assertEquals(AclType.from_acl_response(['algm://.my/*']), AclType.my_algos)
